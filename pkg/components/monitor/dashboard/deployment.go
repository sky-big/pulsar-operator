...
func MakeDeploymentName(c *pulsarv1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-monitor-dashboard-deployment", c.GetName())
}
...
func makeDeploymentSpec(c *pulsarv1alpha1.PulsarCluster) appsv1.DeploymentSpec {
	...
	return appsv1.DeploymentSpec{
		Selector: &metav1.LabelSelector{
			MatchLabels: pulsarv1alpha1.MakeAllLabels(c, pulsarv1alpha1.MonitorComponent, pulsarv1alpha1.MonitorDashboardComponent),
		},
		Replicas: &replica,
