...
func main() {
	...
	err = leader.Become(ctx, "pulsar-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	// Setup Scheme for all components
	...
	// CreateServiceMonitors will automatically create the prometheus-operator ServiceMonitor components
